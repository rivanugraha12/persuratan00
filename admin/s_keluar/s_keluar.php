...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-3">Data Surat Keluar</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="<?= $main_url?>admin.php">Dashboard</a></li>
                <li class="breadcrumb-item active"><a>Data Surat Keluar</a></li>
            </ol>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                            $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_keluar ORDER BY id_keluar DESC");
                            $no = 1;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $data['perihal'] ?></td>
                                    <td>
                                        <a href="lihat.php?id_keluar=<?= $data['id_keluar']; ?>" class="text-primary me-3"><i class="far fa-eye"></i></a>
                                        <a href="edit.php?id_keluar=<?= $data['id_keluar']; ?>" class="text-warning me-3"><i class="fas fa-pen-to-square"></i></a>
                                        <a href="hapus.php?id_keluar=<?= $data['id_keluar']; ?>" class="text-danger "><i class="fa-regular fa-trash-can"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
