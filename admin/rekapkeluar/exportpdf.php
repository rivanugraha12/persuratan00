...
// Nama file PDF
$pdf_filename = "Data Surat keluar.pdf";

// Set dokumen
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('PKL');
$pdf->SetTitle('Data Surat keluar');
$pdf->SetSubject('Rekap Data Surat keluar');
$pdf->SetKeywords('PDF, Data Surat keluar');
...
$html = '<table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
    <thead style="background-color: #4CAF50; color: #fff; text-align: center;">
        <tr>
            <th colspan="7" style="font-size: 16px; font-weight: bold; padding: 10px; background-color: #60D69A; text-align: center; width: 100%">Rekap Data Surat keluar</th>
        </tr>
        <tr>
            ...
            <th style="font-size: 12px; font-weight: bold; padding: 10px; width: 14%;">Tujuan</th>
...
while ($data = mysqli_fetch_array($tampil)) {
    ...
    <td style=\"font-size: 12px; padding: 10px; width: 14%\">{$data['tujuan']}</td>
