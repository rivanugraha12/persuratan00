...
<table border="1">
    <thead>
        <tr>
            <th colspan="6"> Rekapitulasi Data Surat Keluar</th>
        </tr>
        <tr>
            <th>No</th>
            <th>Tanggal</th>
    ...
    <tbody>
        ...
        $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_keluar WHERE tanggal BETWEEN '$tgl1' AND '$tgl2' ORDER BY tanggal ASC");
        $no = 1;
