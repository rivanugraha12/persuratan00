...
<head>
    ...
    <title>Administrasi Surat Masuk & Keluar</title>
                                ...
                                <div class="card-body">
                                    <form class="user" action="cek_login.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="pengguna" class="form-label" id="pengguna"> Sebagai </label>
                                            <select class="form-select form-control mb-4" name="pengguna" id="pilih" required>
                                                <option value="" disabled selected hidden> Pilih Masuk Sebagai...</option>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Administrasi Surat Masuk & Keluar &copy; <?= date('Y') ?> </div>
                    </div>
                </div>
            </footer>
        </div>
